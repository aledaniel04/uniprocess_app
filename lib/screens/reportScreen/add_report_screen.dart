...
import 'package:sqlite_cinco/screens/home_screen.dart';
...
class _AddNoteScreenState extends State<AddNoteScreen> {
  ...
  String _title = "";
  String btnText = "agregar nota";
  String titleText = "agregar notas";

  final TextEditingController _dateController = TextEditingController();

  final DateFormat _dateFormatter = DateFormat("MMM dd, yyy");
  final List<String> _priorities = ["low", "medius", "high"];
  ...
  void initState() {
    ...
    if (widget.note != null) {
      ...
      setState(() {
        btnText = "actualizar nota";
        titleText = "actualizar nota";
      });
    } else {
      setState(() {
        btnText = "agregar nota";
        titleText = "agregar nota";
      });
    }
